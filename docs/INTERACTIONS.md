...
- CyberAI can navigate, summarize local data, listen when explicitly requested, and speak with browser synthesis. Voice simulation requests require manual console confirmation.
- Settings includes an intentional offline demo and recovery actions.
