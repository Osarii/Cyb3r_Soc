...
export type Attack={id:string;type:string;source:string;destination:string;sourceCoordinates:[number,number];destinationCoordinates:[number,number];severity:Severity;startedAt:string;duration:number;progress:number;status:AttackStatus};
