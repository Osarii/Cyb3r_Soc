...
export function ThreatMapReferenceContent() {
  ...
  return <div className="ref-map-page">
    ...
    <div className="ref-map-kpis">
      <MapKpi icon={<Shield/>} label="Ataques en curso" value={String(247+attacks.length)} delta="↗ +12%" danger/>
    ...
    <div className="ref-map-workspace">
      <section className="ref-panel ref-map-stage">
        <div className="ref-panel-head"><div className="mini-star">✦</div><div><b>Mapa de amenazas en tiempo real</b><small>Ataques y actividad global detectada por CyberSOC</small></div><div className="map-filters"><button>Últimas 24 horas⌄</button><button>Todas las amenazas⌄</button></div></div>
      ...
      <aside className="ref-map-console ref-panel">
        ...
        <div className="console-slot"><div className="map-exact-attack"><ExactAttackSwitch/></div></div>
        <div className="quick-actions"><button><Crosshair/> <b>Neutralizar</b><small>Bloquea el ataque activo</small></button><Link to="/mitigation"><Zap/><b>Limpieza</b><small>Elimina rastros del escenario</small></Link><button><Shield/><b>Modo aislado</b><small>Aísla sistemas en prueba</small></button></div>
